...
dt_src_root = os.path.join(dt_root,'coconut/')

sys.path.insert(0, os.path.abspath(os.path.join(dt_src_root,'DATASET/')))
sys.path.insert(0, os.path.abspath(os.path.join(dt_src_root,'src/')))
sys.path.insert(0, os.path.abspath(os.path.join(dt_src_root,'src/Core')))
sys.path.insert(0, os.path.abspath(os.path.join(dt_src_root,'src/Models')))
sys.path.insert(0, os.path.abspath(os.path.join(dt_src_root,'example/')))
sys.path.insert(0, os.path.abspath(os.path.join(dt_src_root,'Externals/')))
