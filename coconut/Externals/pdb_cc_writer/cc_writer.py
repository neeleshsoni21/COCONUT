...
def run_example1(RootDir='./', IMP_Model=False):
    ...
    if IMP_Model == True:
        ...
        model_coiled_coil(os.path.join(RootDir,'./test_example/2zta/Chain-particles.pym', Locus))
...
def run_example2(RootDir='./', IMP_Model=False):
    ...
    Returns:
        None
    """
    fname = os.path.join(RootDir,'./test_example/2zta_long/2zta_long_17mer.fasta')
    oname = os.path.join(RootDir,'./test_example/2zta_long/2zta_long_pseudo')
    ...
    ccparams = read_coiled_coil_parameter_file(os.path.join(RootDir,'./input/standard_cc_dimer_long.par'))
    ...
    if IMP_Model == True:
        Locus = get_coiled_coil_Locus(Helices, ccparams)
        model_coiled_coil(os.path.join(RootDir,'./test_example/2zta_long/Chain-particles.pym', Locus))
...
def run_example3(RootDir='./', IMP_Model=False):
    ...
    Returns:
        None
    """
    fname = os.path.join(RootDir,'./test_example/ccbuilder_dimer/ccbuilder.fasta')
    oname = os.path.join(RootDir,'./test_example/ccbuilder_dimer/ccbuilder_pseudo')
    ...
    ccparams = read_coiled_coil_parameter_file(os.path.join(RootDir,'./input/standard_cc_dimer_ccbuilder.par'))
    ...
    if IMP_Model == True:
        Locus = get_coiled_coil_Locus(Helices, ccparams)
        model_coiled_coil(os.path.join(RootDir,'./test_example/ccbuilder_dimer/Chain-particles.pym', Locus))
...
def run_example4(RootDir='./', IMP_Model=False):
    ...
    Returns:
        None
    """
    fname = os.path.join(RootDir,'./test_example/trimer/1flk_ccdomain.fasta')
    oname = os.path.join(RootDir,'./test_example/trimer/Standard_trimer')
    ...
    ccparams = read_coiled_coil_parameter_file(os.path.join(RootDir,'./input/standard_cc_trimer.par'))
    ...
    if IMP_Model == True:
        Locus = get_coiled_coil_Locus(Helices, ccparams)
        model_coiled_coil(os.path.join(RootDir,'./test_example/trimer/Chain-particles.pym', Locus))
...
def run_example7(RootDir='./', IMP_Model=False, cc_segments=[]):
    ...
    Returns:
        None
    """
    fname1 = os.path.join(RootDir,'./test_example/nup60/Nup60.fasta')
    fname2 = os.path.join(RootDir,'./test_example/nup60/Nup60.fasta')

    oname = os.path.join(RootDir,'./test_example/nup60/Nup60')
    ...
    ccparams = read_coiled_coil_parameter_file(os.path.join(RootDir,'./input/nup60_helix.par'))
    ...
    if IMP_Model == True:
        Locus = get_coiled_coil_Locus(Helices, ccparams)
        model_coiled_coil(os.path.join(RootDir,'./test_example/nup60/Chain-particles.pym', Locus))
...
def run_example8(RootDir='./', IMP_Model=False, cc_segments=[]):
    ...
    Returns:
        None
    """
    fname1 = os.path.join(RootDir,'./test_example/nup1/Nup1.fasta')
    fname2 = os.path.join(RootDir,'./test_example/nup1/Nup1.fasta')

    oname = os.path.join(RootDir,'./test_example/nup1/Nup1')
    ...
    ccparams = read_coiled_coil_parameter_file(os.path.join(RootDir,'./input/nup1_helix.par'))
    ...
    if IMP_Model == True:
        Locus = get_coiled_coil_Locus(Helices, ccparams)
        model_coiled_coil(os.path.join(RootDir,'./test_example/nup1/Chain-particles.pym', Locus))
...
def run_example9(RootDir='./', IMP_Model=False, cc_segments=[]):
    ...
    Returns:
        None
    """
    fname1 = os.path.join(RootDir,'./test_example/mlp_cc_cw_unified/MLP.fasta')
    fname2 = os.path.join(RootDir,'./test_example/mlp_cc_cw_unified/MLP.fasta')
    oname = os.path.join(RootDir,'./test_example/mlp_cc_cw_unified/MLP_MLP_Random')

    prot1='MLP'
    prot2='MLP'

    alifile=os.path.join(RootDir,'./test_example/mlp_cc_cw_unified/'+prot1+'_'+prot2+'_CW_alignment.cali')
    paircoilfile1 = os.path.join(RootDir,'./test_example/mlp_cc_cw_unified/'+prot1+'_paircoil2.out')
    paircoilfile2 = os.path.join(RootDir,'./test_example/mlp_cc_cw_unified/'+prot2+'_paircoil2.out')
    ...
    ccparams = read_coiled_coil_parameter_file(os.path.join(RootDir,'./input/mlp_ccdimer.par'))
    ...
    if IMP_Model == True:
        Locus = get_coiled_coil_Locus(Helices, ccparams)
        model_coiled_coil(os.path.join(RootDir,'./test_example/mlp_cc_cw_unified/Chain-particles.pym', Locus))
...
def run_example12(RootDir='./', IMP_Model=False, cc_segments=[]):
    ...
    Returns:
        None
    """
    fname1 = os.path.join(RootDir,'./test_example/MuTPR/MuTPR.fasta')
    fname2 = os.path.join(RootDir,'./test_example/MuTPR/MuTPR.fasta')
    oname = os.path.join(RootDir,'./test_example/MuTPR/MuTPR_MuTPR')

    prot1='MuTPR'
    prot2='MuTPR'

    alifile=os.path.join(RootDir,'./test_example/MuTPR/'+prot1+'_'+prot2+'_alignment.cali')
    paircoilfile1 = os.path.join(RootDir,'./test_example/MuTPR/'+prot1+'_paircoil2_new.out')
    paircoilfile2 = os.path.join(RootDir,'./test_example/MuTPR/'+prot2+'_paircoil2_new.out')
    ...
    ccparams = read_coiled_coil_parameter_file(os.path.join(RootDir,'./input/mu_tpr_ccdimer.par'))
    ...
    if IMP_Model == True:
        Locus = get_coiled_coil_Locus(Helices, ccparams)
        model_coiled_coil(os.path.join(RootDir,'./test_example/numa_cc/Chain-particles.pym', Locus))
...
def run_example13(RootDir='./', IMP_Model=False, cc_segments=[]):
    ...
    Returns:
        None
    """
    fname1 = os.path.join(RootDir,'./test_example/munup153/Nup153.fasta')
    fname2 = os.path.join(RootDir,'./test_example/munup153/Nup153.fasta')

    oname = os.path.join(RootDir,'./test_example/munup153/Nup153')
    ...
    ccparams = read_coiled_coil_parameter_file(os.path.join(RootDir,'./input/nup153_helix.par'))
...
def run_example15(RootDir='./', IMP_Model=False, cc_segments=[]):
    ...
    Returns:
        None
    """
    fname1 = os.path.join(RootDir,'./test_example/k5k14/k5.fasta')
    fname2 = os.path.join(RootDir,'./test_example/k5k14/k14.fasta')
    oname = os.path.join(RootDir,'./test_example/k5k14/k5k14')

    prot1='k5'
    prot2='k14'
    #alifile=os.path.join(RootDir,'./test_example/mlp_cc/'+prot1+'_'+prot2+'_alignment.cali'

    alifile=os.path.join(RootDir,'./test_example/k5k14/'+prot1+'_'+prot2+'_alignment.cali')
    paircoilfile1 = os.path.join(RootDir,'./test_example/k5k14/'+prot1+'_pcoils.out')
    paircoilfile2 = os.path.join(RootDir,'./test_example/k5k14/'+prot2+'_pcoils.out')
    ...
    ccparams = read_coiled_coil_parameter_file(os.path.join(RootDir,'./input/k5k14_ccdimer.par'))
    ...
    if IMP_Model == True:
        ...
        model_coiled_coil(os.path.join(RootDir,'./test_example/k5k14/Chain-particles.pym', Locus))
